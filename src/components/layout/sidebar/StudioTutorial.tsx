    ...
    const steps = [
        {
            ...
            content: 'Welcome to CodeVideo Studio! This tutorial will guide you through the various features of the studio.',
            disableBeacon: true,
        },
        {
        ...
        },
        {
            ...
            content: 'Click here to move to the next action in your project. The IDE preview to the right will update in realtime and reflect the action you are currently editing.',
            disableBeacon: true,
        },
        {
            target: `.${TutorialCSSClassConstants.STUDIO_NAVIGATION_PLUS_TEN_BUTTON}`,
            content: 'Click here to skip ahead 10 actions in the list. You can likewise jump back 10 actions or jump to the beginning or end of the actions list. Everything in CodeVideo studio is alway 100% time-travelable.',
            disableBeacon: true,
        },
        {
        ...
        },
        {
            ...
            content: 'Click here to start recording actions. Recording actions directly in the IDE is still in beta, so we recommend using the standard action editor for now.',
            disableBeacon: true,
        },
        {
        ...
        },
        {
            ...
            content: 'We also have a playback feature, still in beta. Clicking this will start the actions at the start and play them back, resulting in an animation similar to the video or gif you can expect to generate from your project.',
            disableBeacon: true,
        },
        {
            target: `.${TutorialCSSClassConstants.HEADER_SELECTOR}`,
            content: "That's all for now. We hope you enjoy using CodeVideo Studio! If you have any comments or questions, please don't hesitate to reach out to us at hi@fullstackcraft.com.",
            disableBeacon: true,
        },
    ]
        ...
        <Joyride
            callback={(data) => {
                if (data.action === 'close') {
                    mixpanel.track('Tutorial Closed Studio');
                    dispatch(endTutorial());
                }
                if (data.action === 'reset') {
                    mixpanel.track('Tutorial Finished Studio');
                    dispatch(endTutorial());
                }
            }}
