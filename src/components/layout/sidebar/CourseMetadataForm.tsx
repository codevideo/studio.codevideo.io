  ...
  return (
    ...
    <Card >
      ...
      <Box mt="6" pt="4">
        ...
        {/* Add Lesson Form */}
        {isAddingLesson && (
          <LessonMetadataForm forCourse={true} isEdit={false} onCancel={() => setIsAddingLesson(false)}/>
        )}
      </Box>
      ...
      <Flex justify="end" gap="3" mt="6">
        <Button
          type="button"
          onClick={() => isEdit ? dispatch(setLocationInStudio('studio')) : dispatch(setLocationInStudio('select'))}
          variant="solid"
          color="red"
          size="2"
        >
